     ...
     <a class="navbar-brand" href="index.php"><i class="flaticon-university"></i>Dakshbharti <br><small>Portal</small></a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <li class="nav-item"><a href="index.php" class="nav-link">Home</a></li>
          ...
          <li class="nav-item"><a href="digi.php" class="nav-link">Digital library</a></li>
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-8 ftco-animate text-center">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Quiz</span></p>
              <h1 class="mb-3 bread">Quiz</h1>
            </div>
          </div>
        </div>
      </div>
