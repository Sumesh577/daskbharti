...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
         <a class="navbar-brand" href="index.php"><i class="flaticon-university"></i>Dakshbharti <br><small>Portal</small></a>
         ...
         <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item"><a href="#" class="nav-link">Digital library</a></li>
               <li class="nav-item"><a href="quiz.php" class="nav-link">Quiz</a></li>
               <li class="nav-item"><a href="event.php" class="nav-link">Events</a></li>
               <li class="nav-item"><a href="#" class="nav-link">Ref Document</a></li>
   ...
   <section class="ftco-counter bg-light" id="section-counter">
      <div class="container">
         <div class="col-md-12 d-flex justify-content-center mb-5">
            ...
            <button type="button" class="btn btn-outline-black waves-effect filter" data-rel="1">Video</button>
            <button type="button" class="btn btn-outline-black waves-effect filter" data-rel="2">Image</button>
         ...
         <div class="row d-md-flex justify-content-center">
            <div class="col-md-9 about-video text-center">
               ...
               <div class="video d-flex justify-content-center">
                  <a href="https://vimeo.com/45830194" class="button popup-vimeo d-flex justify-content-center align-items-center"><span
         ...
         <div class="row mb-5">
            <div class="col-md-3">
               <div class="ftco-footer-widget mb-4">
                  <h2><a class="navbar-brand" href="index.php"><i class="flaticon-university"></i>Dakshbharti <br><small>Portal</small></a></h2>
                  <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there
